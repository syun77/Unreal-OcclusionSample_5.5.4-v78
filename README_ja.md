...
- https://developers.meta.com/horizon/design/mr-health-depth/?utm_source=chatgpt.com によると4mを超えると深度システムの限界があるとの記載はありますが念のための確認となります
...
こちらは元のプロジェクトの通り、[A] or [X] で「通常」「ハードオクリュージョン」「ソフトオクリュージョン」の3つを切り替える方法となっています。
